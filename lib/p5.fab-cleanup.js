...
/**
 * Keep track of the XYZE axis positions, speed (F),  and comments (C).
 * @typedef {Object} XYZEFC
 * @property {Number} x - The X axis position.
 * @property {Number} y - The Y axis position.
 * @property {Number} z - The Z axis position.
 * @property {Number} e - The E axis position.
 * @property {Number} f - The speed (in mm/min).
 * @property {String} c - The comment.
 */
class XYZEFC {
...
/**
 * The `fab` object represents the machine. It is the main interface between your sketch and the machine. 
 * 
 * By default, it is configured for an Ender 3 3D printer. You can specify a `config` when using another machine. 
 * 
 * @property {String} printer - The name of the printer.
 * @property {Number} maxX - The maximum X position.
 * @property {Number} maxY - The maximum Y position.
 * @property {Number} maxZ - The maximum Z position.
 * @property {Number} centerX - The center X position.
 * @property {Number} centerY - The center Y position.
 * @property {String} coordinateSystem - The coordinate system of the printer (e.g. cartesian, delta).
 * @property {Number} radius - The radius of the printer (for delta printers).
 * @property {Number} nozzleDiameter - The diameter of the nozzle installed on the machine.
 * @property {Number} filamentDiameter - The diameter of the filament being used.
 * @property {Number} baudRate - The baud rate for serial communication. Defaults to 115200.
 * @property {Boolean} autoConnect - Automatically connect to the machine when a port is available. Defaults to true.
 */
class Fab {
  /**
   * 
   * @param {Object} [config] - The machine config data. Defaults to Ender3 printer values.
   */
  constructor(config = defaultPrinterSettings) {
    ...
    /** The commands used to render the model */
